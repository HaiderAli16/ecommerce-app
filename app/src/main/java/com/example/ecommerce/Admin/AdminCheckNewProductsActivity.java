...
public class AdminCheckNewProductsActivity extends AppCompatActivity {
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerOptions<Products> options = new FirebaseRecyclerOptions.Builder<Products>()
                .setQuery(unvarifiedRef.orderByChild("productState").equalTo("Not Approved"), Products.class).build();
    ...
    private void changeProductState(String productID) {
        unvarifiedRef.child(productID).child("productState").setValue("Approved").addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
            public void onComplete(@NonNull Task<Void> task) {
                Toast.makeText(AdminCheckNewProductsActivity.this, "That Item Has Been Approved, and it is now available in sale", Toast.LENGTH_SHORT).show();
            }
        });
